...
metadata:
  ...
  labels:
    app: {{ .msvc }}
    {{- include "universal-app-chart.selectorLabels" $global | nindent 8 }}
    {{- include "universal-app-chart.istioLabels" $global | nindent 8 }}
    {{- if $labels -}} {{- toYaml $labels | nindent 8 }} {{- end }}
    {{- if $selectorLabels -}} {{- toYaml $selectorLabels | nindent 8 }} {{- end }}
    {{- include "universal-app-chart.labels" $global | nindent 8 }}
spec:
