...
{{- define "2f.uchart.lib.pod.field.initContainers" -}}
  ...
  {{- range $key, $containerValues := $workloadObject.initContainers -}}
    ...
    {{- if $containerEnabled -}}
      ...
      {{- include "2f.uchart.lib.container.validate" (dict "root" $ "workloadObject" $workloadObject "containerObject" $containerObject) -}}
