...
{{- define "2f.uchart.lib.networkPolicy.blueprint" -}}
  {{- $root := .root -}}
...
spec:
  ...
  ingress: {{- include "2f.uchart.lib.networkPolicy.field.ingress" (dict "root" $root "object" $networkPolicyObject) | nindent 4 -}}
  {{- end }}
  {{- with $networkPolicyObject.rules.egress }}
  egress: {{- include "2f.uchart.lib.networkPolicy.field.egress" (dict "root" $root "object" $networkPolicyObject) | nindent 4 -}}
  {{- end }}
{{- end -}}
