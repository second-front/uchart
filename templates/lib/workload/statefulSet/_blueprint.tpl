...
{{- define "2f.uchart.lib.workload.statefulSet.blueprint" -}}
  {{- $root := .root -}}
...
spec:
  ...
  {{- with (include "2f.uchart.lib.workload.statefulSet.field.volumeClaimTemplates" (dict "root" $root "statefulSetObject" $statefulSetObject)) }}
